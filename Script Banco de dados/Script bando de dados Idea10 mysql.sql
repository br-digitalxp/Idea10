...
CREATE TABLE tb_substrato(
    ...
    id_substrato        INT AUTO_INCREMENT PRIMARY KEY NOT NULL,
...
CREATE TABLE tb_tamanho_substrato(
    ...
    id_tamanho_substrato INT AUTO_INCREMENT PRIMARY KEY NOT NULL,
    vl_x                INT               NOT NULL, 
    vl_y        	    INT         	  NOT NULL, 
    dt_cadastro         DATETIME     	  NOT NULL, 
...
CREATE TABLE tb_categoria_imagem(
    ...
    id_categoria_imagem    INT AUTO_INCREMENT PRIMARY KEY NOT NULL,
...
CREATE TABLE tb_ordem_servico(
    ...
    id_ordem_servico       INT AUTO_INCREMENT PRIMARY KEY NOT NULL,
